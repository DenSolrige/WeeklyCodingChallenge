...
public class AtBash {
    ...
    public static String atbash(String input){
        return input.chars().mapToDouble(c->(double)c).map(c ->
                (int)(3/((((c-65)-12.5)/13.0*((c-65)-12.5)/13.0)+2))*(2*'A'+25-c)
                +(int)(3/((((c-97)-12.5)/13.0*((c-97)-12.5)/13.0)+2))*(2*'a'+25-c)
                +(1-(int)(3/((((c-65)-12.5)/13.0*((c-65)-12.5)/13.0)+2))-(int)(3/((((c-97)-12.5)/13.0*((c-97)-12.5)/13.0)+2)))*c)
